...
public class MergeSort {
    // Divide el arreglo recursivamente, ordena y mezcla ambas mitades
    ...
    // Partición recursiva en mitades hasta llegar a subarreglos de un elemento
    ...
    // Mezcla dos subarreglos ordenados en uno solo utilizando un arreglo auxiliar
    private static void merge(int[] arr, int[] temp, int left, int mid, int right) {
        ...
        while (i <= mid) arr[k++] = temp[i++]; // Copia los elementos restantes de la izquierda
    }
}